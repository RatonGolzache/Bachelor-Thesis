...
def convert(cfg):
    ...
    checkpoint = torch.load("D:/Bsc-Thesis/frankenstein/checkpoint_frankenstein_novae_groups/model.ckpt-500.pt", map_location=lambda storage, loc: storage)
