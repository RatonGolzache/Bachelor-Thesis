...
def train_model(cfg):
    ...
    #spk_classifier_spk = ClassifierSpk(256, 128, cfg.classifier_num_speakers) # classifier from speaker embedding
    #spk_classifier_content = ClassifierContent(64, 32, cfg.classifier_num_speakers) # classifier from content embedding
    #spk_classifier_emo = ClassifierEmo(256, 128, cfg.classifier_num_speakers) # classifier from style embedding
